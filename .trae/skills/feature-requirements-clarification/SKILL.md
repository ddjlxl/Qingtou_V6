...
version: "2.0.0"
tags: [requirements, clarification, feature, planning, ac]
---
...
- 检查 `specs/product-overview.md` 是否存在，存在则读取
- 检查 `specs/development-roadmap.md` 是否存在，存在则读取
...
确认完成后：
1. 读取 `assets/feature-requirements-template.md` 作为生成基准
2. 填充内容，生成最终文档
3. 保存到 `specs/features/<feature-name>/requirements.md`
