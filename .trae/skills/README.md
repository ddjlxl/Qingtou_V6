...
| # | Skill | 说明 |
|---|-------|------|
| 12 | `testing` | 测试编写与执行（含浏览器测试） |
| 13 | `code-review` | 代码质量审查 |
| 14 | `bug-fix` | BUG 系统化修复（含问题分级、根因追溯、多层防护） |
| 15 | `performance-optimization` | 性能分析与优化 |
| 16 | `verification-before-completion` | 完成前强制验证门禁 |
| 17 | `refactor-plan` | 多文件重构规划（影响分析+回滚方案） |
...
| # | Skill | 说明 |
|---|-------|------|
| 18 | `feature-iteration` | 功能迭代变更（含 CR 编号、开发中场景支持） |
...
| # | Skill | 说明 |
|---|-------|------|
| 19 | `finishing-a-development-branch` | Git 分支收尾（验证→合并/PR/保留/丢弃） |
| 20 | `frontend-design` | 前端界面设计品质指导 |
