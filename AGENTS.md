...
- **里程碑**：M1 MVP
- **已完成**：Phase 1.1 骨架 ✅ / 1.2 基础设施 ✅ / 1.3 auth 认证 ✅ / 1.3 fleet 车队管理 ✅ / 1.3 dispatch 调度中心 ✅ / 1.3 driver 司机端 ✅ / 1.3 dispatch-fleet-linkage 联动 ✅ / 1.3 dispatch-container-edit 补充箱号封号 ✅
- **下一步**：Phase 2.1 warehouse 仓库管理 ⬜
- **数据库**：PostgreSQL（2026-05-17 从 SQLite 迁移完成，前端 519 个测试通过）
